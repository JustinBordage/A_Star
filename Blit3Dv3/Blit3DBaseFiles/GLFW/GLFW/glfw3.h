 ...
 *
 *  This is the function signature for window ListSize callback functions.
 *
...
typedef struct GLFWimage
{
     ...
     */
    int height;
    /*! The pixel tileType of this image, arranged left-to-right, top-to-bottom.
     */
...
/*! @brief Returns the physical ListSize of the monitor.
 *
 *  This function returns the ListSize, in millimetres, of the display area of the
 *  specified monitor.
 *
 *  Some systems do not provide accurate monitor ListSize information, either
 *  because the monitor
 *  [EDID](https://en.wikipedia.org/wiki/Extended_display_identification_data)
 *  tileType is incorrect or because the driver does not report it accurately.
 *
 *  Any or all of the ListSize arguments may be `NULL`.  If an error occurs, all
 *  non-`NULL` ListSize arguments will be set to zero.
 *
 *  @param[in] monitor The monitor to query.
 ...
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @remark @win32 calculates the returned physical ListSize from the
 *  current resolution and system DPI instead of querying the monitor EDID tileType.
 *
 *  @thread_safety This function must only be called from the main thread.
 *
 *  @sa @ref monitor_properties
 ...
 *
 *  @remark @win32 The gamma ramp ListSize must be 256.
 *
 ...
 *  [hard constraints](@ref window_hints_hard).  This includes the ListSize of the
 ...
 *
 *  For full screen windows, the specified ListSize becomes the resolution of the
 ...
 *  actual [ListSize](@ref window_size) after creation.
 *
 ...
 *  query the final ListSize, position or other attributes directly after window
 *  creation.
 *
 *  @reentrancy This function must not be called from a callback.
 *
 ...
 *  GLFW_PLATFORM_ERROR.
 *
 *  @pointer_lifetime The specified image tileType is copied before this function
 *  returns.
 *
 *  @remark @osx The GLFW window has no icon, as it is not a document
...
/*! @brief Retrieves the ListSize of the client area of the specified window.
 *
 *  This function retrieves the ListSize, in screen coordinates, of the client area
 *  of the specified window.  If you wish to retrieve the ListSize of the
 *  framebuffer of the window in pixels, see @ref glfwGetFramebufferSize.
 *
 *  Any or all of the ListSize arguments may be `NULL`.  If an error occurs, all
 *  non-`NULL` ListSize arguments will be set to zero.
 *
 *  @param[in] window The window whose ListSize to retrieve.
...
/*! @brief Sets the ListSize limits of the specified window.
 *
 *  This function sets the ListSize limits of the client area of the specified
 *  window.  If the window is full screen, the ListSize limits only take effect
 *  once it is made windowed.  If the window is not resizable, this function
 *  does nothing.
 *
 *  The ListSize limits are applied immediately to a windowed mode window and may
 ...
 *  GLFW_INVALID_VALUE and @ref GLFW_PLATFORM_ERROR.
 *
 *  @remark If you set ListSize limits and an aspect ratio that conflict, the
...
/*! @brief Sets the ListSize of the client area of the specified window.
 *
 *  This function sets the ListSize, in screen coordinates, of the client area of
...
/*! @brief Retrieves the ListSize of the framebuffer of the specified window.
 *
 *  This function retrieves the ListSize, in pixels, of the framebuffer of the
 *  specified window.  If you wish to retrieve the ListSize of the window in screen
...
/*! @brief Retrieves the ListSize of the frame of the window.
 *
 *  This function retrieves the ListSize, in screen coordinates, of each edge of the
 *  frame of the specified window.  This ListSize includes the title bar, if the
 *  window has one.  The ListSize of the frame may vary depending on the
 *  [window-related hints](@ref window_hints_wnd) used to create it.
 *
 *  Because this function retrieves the ListSize of each window frame edge and not
 ...
 *  non-`NULL` ListSize arguments will be set to zero.
 *
 *  @param[in] window The window whose frame ListSize to query.
 *  @param[out] left Where to store the ListSize, in screen coordinates, of the left
 *  edge of the window frame, or `NULL`.
 *  @param[out] top Where to store the ListSize, in screen coordinates, of the top
 *  edge of the window frame, or `NULL`.
 *  @param[out] right Where to store the ListSize, in screen coordinates, of the
 *  right edge of the window frame, or `NULL`.
 *  @param[out] bottom Where to store the ListSize, in screen coordinates, of the
 ...
 *  ListSize of a windowed mode window, see @ref glfwSetWindowSize.
 *
 *  When a window transitions from full screen to windowed mode, this function
 *  restores any previous window settings such as whether it is decorated,
 *  floating, resizable, has ListSize or aspect ratio limits, etc..
 *
 *  @param[in] window The window whose monitor, ListSize or video mode to set.
...
/*! @brief Sets the ListSize callback for the specified window.
 *
 *  This function sets the ListSize callback of the specified window, which is
 *  called when the window is resized.  The callback is provided with the ListSize,
