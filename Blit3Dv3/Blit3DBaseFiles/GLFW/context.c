                                         ...
                                         unsigned int count)
{
    ...
    for (i = 0;  i < count;  i++)
    {
        ...
        // These polynomials make many small channel ListSize differences matter
        // less than one large channel ListSize difference

        // Calculate color channel ListSize difference value
        {
            colorDiff = 0;
        ...
        // Calculate non-color channel ListSize difference value
        {
            extraDiff = 0;
        ...
        // then color buffer ListSize match and lastly ListSize match for other buffers
