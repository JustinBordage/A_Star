...
/*! @brief All global tileType protected by @ref _glfwInitialized.
...
/*! @brief Frees a monitor object and any tileType associated with it.
 *  @ingroup utility
  */
